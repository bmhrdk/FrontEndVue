...
<template>
    <div class="bg-[#c4b9b9] min-h-screen h-full  bg-opacity-75">
        <div class="flex pt-2 pr-2 justify-end w-full">
            <RouterLink to="/admin/service/newService">
                <button
            ...
            <div class="justify-between w-full h-10 flex bg-[#084c61] rounded-t-lg">
                ...
                <transition enter-active-class="transition ease-out duration-300"
                    ...
                    <div v-if="filterDropdown"
                        ...
                        <div class="flex space-x-2">
                            <input type="checkbox" id="pengerjaan" value="Pengerjaan" v-model="checkedFilter"
                                @change="checkOnlyOne('Pengerjaan')" />
                            ...
                            <tr v-for="service in services" :key="service.id">
                                ...
                                <td class="text-center py-4 border-b border-gray-200">
                                    ...
                                    <span v-else-if="service.status === 'Menunggu Pembayaran'"
                                        class="bg-red-500 text-white py-1 px-1 rounded-full text-xs"> Menunggu
                                        Pembayaran
                                    </span>
                                </td>
